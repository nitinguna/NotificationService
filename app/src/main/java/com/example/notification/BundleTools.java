        ...
        try
        {
            ...
            for(String key:keys)
            {
                ...
                if ( o instanceof String )
                {
                    ...
                    else jsonObject.put(key,(String)o);
                }
                else if ( o instanceof Integer ) jsonObject.put(key,(Integer)o);
                else if ( o instanceof Boolean ) jsonObject.put(key,(Boolean)o);
